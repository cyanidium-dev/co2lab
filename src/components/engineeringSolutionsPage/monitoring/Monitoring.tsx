    ...
    <section className="py-12 lg:pt-30 lg:pb-0">
      <Container>
        <div className="relative px-3 lg:px-6.5 py-8 lg:py-16 rounded-[18px] overflow-hidden">
          <div className="absolute -z-10 inset-0 bg-[linear-gradient(0deg,rgba(38,38,38,0.4),rgba(38,38,38,0.4)),linear-gradient(270deg,rgba(0,0,0,0)_0%,rgba(0,0,0,0.4)_59.13%)]"></div>
          <Image
          ...
          <p className="mb-11.5 lg:mb-8 text-[12px] lg:text-[16px] font-light leading-[120%] text-white">
            ...
            content, oxygen levels, contaminants, and compliance with food- and
          ...
          <p className="text-[12px] lg:text-[16px] font-light leading-[120%] text-white">
